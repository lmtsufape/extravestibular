        ...
        <div class="card-body">
          <div class="row justify-content-left">
            <div class="col-sm-12">
              ...
              <label for="">
                a) O aluno só pode ser reintegrado ao seu <b>curso</b> e <b>Unidade</b> (SEDE, UAG, UAST e UACSA) de origem, bem como ao turno ao qual estava vinculado;
              </label>
            </div>
          </div>
          ...
          <div class="row justify-content-left">
            <div class="col-sm-12">
              ...
              <label for="">
                b) Não tiver sido <b>desligado</b> de um Curso da UFRPE, exceto o requerente que tenha cumprido
                com aprovação no mínimo 90% da carga horária total de seu curso (excluída deste total a
                carga horária referente à disciplina Estágio Curricular Obrigatório, Monografia ou Trabalho de
                Conclusão de Curso), que em um semestre de vínculo possa integralizar o curso, neste caso
                poderá solicitar a apreciação de sua situação e que esteja com Estágio Curricular Obrigatório,
                Monografia ou Trabalho de Conclusão de Curso pronto para a defesa atendendo <b>Resolução/
                354/2008;</b>
              </label>
            </div>
          </div>
          ...
          <div class="row justify-content-left">
            <div class="col-sm-12">
              ...
              <label for="">
                c) Não tiver pedido <b>desistência</b> da sua vaga. No caso do aluno ter <b>desistido</b> da sua vaga no
                curso, ele não poderá ser reintegrado;
              </label>
            </div>
          </div>
          ...
          <div class="row justify-content-left">
            <div class="col-sm-12">
              ...
              <label for="">
                d) Dispuser de tempo para integralização do currículo pleno do Curso de Graduação, dentro
                do prazo máximo estabelecido pelo CNE e UFRPE, considerando, para tanto, o prazo anterior
                de vínculo ativo e mais os semestres que o mesmo deveria utilizar para concluir o curso;
              </label>
            </div>
          </div>
          ...
          <div class="row justify-content-left">
            <div class="col-sm-12">
              ...
              <label for="">
                e) Não ter decorrido, no intervalo de afastamento, o tempo máximo de integralização do
                Curso; e
              </label>
            </div>
          </div>
          ...
          <div class="row justify-content-left">
            <div class="col-sm-12">
              <input type="checkbox" class="form-check-input" id="checkCriterioF" onclick="selectCriterio('f')">
              <label for="">
