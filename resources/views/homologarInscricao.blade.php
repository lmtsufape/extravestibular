            ...
            <div class="card" style="width: 70rem; ">
              ...
              <div class="card-body">
                <div class="form-group row" style="margin-left:12.2rem;">
                  <div class="form-group row">    <!-- Curso pretendido/turno/polo -->
                  ...
                  <div class="form-group row justify-content-center" style="font-weight: bold; margin-left: 10rem; width: 60rem">

                    <div class="col-md-11">
                      <input onclick="selectCheck('aprovado')" id="selectInscricaoAprovado" type="radio" name="radioInscricao" value="aprovado"> Aprovado
            ...
            <div class="card" style="width: 70rem; margin-top: 15px">
                ...
                <div class="card-body">
                  ...
                  <div class="form-group row justify-content-center" style="font-weight: bold; margin-left: 23rem; width: 60rem; margin-top: 15px;">
                    ...
                    <div class="col-md-11">
                        <input onclick="selectCheck('aprovado')" id="selectDadosPessoaisAprovado" type="radio" name="radioDadosPessoais" value="aprovado"> Aprovado
